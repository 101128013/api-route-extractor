HTTP/1.1 200 OK
Date: Mon, 17 Nov 2025 17:19:00 GMT
X-Content-Type-Options: nosniff
Access-Control-Allow-Origin: www.login.security.gov.on.ca
Access-Control-Allow-Credentials: true
Access-Control-Allow-Methods: GET, POST, OPTIONS
Access-Control-Allow-Headers: Origin, Content-Type, Accept, x-requested-with, x-xsrf-token
X-Frame-Options: SAMEORIGIN
Accept-Ranges: bytes
Content-Length: 16925
Last-Modified: Sun, 25 Aug 2024 10:35:28 GMT
X-ORACLE-DMS-ECID: 006GwqB3KzREgKG^UxR5Es0001Up001arz
